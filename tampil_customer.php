...
if(isset($_POST['submit2'])){
  ...
  $sql="SELECT * FROM  pesan where tanggalpesan between '$qcari' and '$qcari2'";
}
...
echo "<b><tr><td>No.</td><td>Nama Pelanggan</td><td>Alamat</td><td>Tanggal Pesan</td><td>Jumlah Bayar</td><td>Total Jumlah Barang</td><td colspan=2><center> Aksi</center></td></tr>";
if ($data->num_rows > 0){
  $no = 1;
